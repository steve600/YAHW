...
namespace YAHW.Events
{
    /// <summary>
    /// <para>
    /// Custom EventArgs-Class for the position changed event of a sensor tile
    /// </para>
    /// 
    /// <para>
    /// Class history:
    ...
    /// </summary>
    public class SensorTilePositionChangedEventArgs : EventArgs
    {
        ...
        public int OldGridRow { get; set; }
        public int OldGridColumn { get; set; }
        public int NewGridRow { get; set; }
        public int NewGridColumn { get; set; }
        public SensorTile SensorTile { get; set; }
    }
}