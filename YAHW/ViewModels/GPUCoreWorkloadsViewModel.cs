...
namespace YAHW.ViewModels
{
    ...
    /// </summary>
    public class GPUCoreWorkloadsViewModel : ViewModelBase
    {
        ...
        /// CTOR
        /// </summary>
        public GPUCoreWorkloadsViewModel()
        {
        ...
        void timer_Tick(object sender, EventArgs e)
        {
            if (this.openHardwareManagementService.GPU != null)
            {
                ...
                // Get core workload
                foreach (var sensor in this.openHardwareManagementService.GPUCoreWorkloadSensors)
                {
