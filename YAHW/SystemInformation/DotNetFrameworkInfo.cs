...
namespace YAHW.SystemInformation
{
    public static class DotNetFrameworkInfo
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<NetFrameworkVersionInfo> InstalledDotNetVersions()
        {
            List<NetFrameworkVersionInfo> versions = new List<NetFrameworkVersionInfo>();
        ...
        private static void GetDotNetVersion(RegistryKey parentKey, string subVersionName, List<NetFrameworkVersionInfo> versions)
        {
            if (parentKey != null)
            {
